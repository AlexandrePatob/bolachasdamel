...
-- ============================================
-- 4. Produtos Páscoa 2026 (batch insert)
-- ============================================
-- Garante que unit_quantity existe em products
...
-- 4.2 product_options (Amanteigados: embalagens)
...
-- 4.3 product_options (Quadradinho: designs)
INSERT INTO product_options (product_id, type, name, price_delta)
...
-- 4.4 product_options (Bolachas no Ovo: tipo)
INSERT INTO product_options (product_id, type, name, price_delta)
...
-- 4.5 product_quantity_rules (Palitos de Chocolate)
...
-- 4.6 product_quantity_rules (Rodinha de Páscoa)
INSERT INTO product_quantity_rules (product_id, min_qty, max_qty, price, extra_per_unit)
...
-- 4.7 product_quantity_rules (Quadradinho de Chocolate)
INSERT INTO product_quantity_rules (product_id, min_qty, max_qty, price, extra_per_unit)
...
-- 4.8 product_quantity_rules (Jogo da Memória Semana Santa)
INSERT INTO product_quantity_rules (product_id, min_qty, max_qty, price, extra_per_unit)
...
-- 4.9 product_quantity_rules (Bolachas no Ovo)
INSERT INTO product_quantity_rules (product_id, min_qty, max_qty, price, extra_per_unit)
